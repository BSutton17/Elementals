...
const KINGDOMS: Record<string, { id: string; name: string; paint?: unknown }[]> = {
  ...
  time: [
    { id: 'time-standard', name: 'Standard' },
    {
      id: 'clockwork',
      name: 'Clockwork Castle',
      paint: { fill: '#7a5a33', accent: '#d9c39a', outline: '#221507', decor: 'time.clockwork' },
    },
    {
      id: 'chrono',
      name: 'Chrono Tower',
    ...
    ...[101, 2402, 77777, 5150].map((seed, i) => ({
      id: `rift-${i}`,
      name: `Rift seed ${seed}`,
      paint: {
        gradient: { from: '#9c7a4c', to: '#43301c' },
  ...
  space: [
    { id: 'space-standard', name: 'Standard' },
    {
      id: 'starpattern',
      name: 'Star Pattern Castle',
      paint: { fill: '#3b2470', accent: '#8fb8ff', outline: '#080418', decor: 'space.starpattern' },
    },
    {
      id: 'spaceship',
